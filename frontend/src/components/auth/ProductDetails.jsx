...
const ProductDetails = () => {
    ...
    return (
        <div className="min-h-screen w-full bg-blue-800 text-white">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="flex flex-col justify-between">
                        <div>
                            ...
                            {/* ✅ Quantity Input */}
                            <div className="flex items-center bg-white p-2 pl-3 rounded-[10px] w-50 gap-4 mb-4">
                ...
                <div className="max-w-6xl mx-auto mt-12 p-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
                        {otherProducts.map((product) => (
                            ...
                            >
                                <div className="w-full h-[160px] flex justify-center items-center bg-white rounded-lg">
                                    {product.images?.[0] ? (
                                        <img
                                            src={`http://localhost:8000/uploads/${product.images[0]}`}
                                            alt={product.name}
