...
const Card = ({ id, name, price, image, onAddToCart, onBuyNow, onEdit, onDelete }) => {
  ...
  return (
    <div className="bg-blue-900 rounded-xl shadow-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-2xl border border-gray-200 w-full max-w-sm">
      {/* Product Image */}
