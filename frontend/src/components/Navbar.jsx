...
function Navbar() {
  ...
  return (
    <div className="h-16 fixed top-0 left-0 right-0 z-1 w-full bg-yellow-900 text-white flex items-center justify-between px-6 shadow-lg">
      <h1 className="text-2xl font-semibold tracking-wide">
        Maxxi-<span>Kart</span>
      </h1>
      ...
      <div className="space-x-4">
        {user ? (
          <>
              ...
              <span className="text-lg font-medium">Hello <span className='text-yellow-300'>{user.name}</span>😊</span>
            <button
