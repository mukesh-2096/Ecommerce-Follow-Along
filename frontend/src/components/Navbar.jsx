...
function Navbar({ hideButtons = false }) {
  ...
  return (
    <nav className="h-16 fixed top-0 left-0 right-0 z-10 w-full bg-blue-900 text-white shadow-lg">
          ...
          {user ? (
            <>
              <span className="text-2xl font-semibold">
                Hello,<span className="font-semibold text-yellow-300">{capitalize(user.name)}😊</span>
              </span>
